defmodule Table.Impl do
  ...
  #@red ~w(1 3 5 7 9 12 14 16 18 19 21 23 25 27 29 32 34 36)
  #@black ~w(2 4 6 8 10 11 13 15 17 20 22 24 26 28 29 31 33 35)
  #@green ~w(0 00)
  ...
  #def spinner(numbers \\ @numbers, colors \\ @colors) do
  #  Enum.zip(numbers, colors)
  #end
